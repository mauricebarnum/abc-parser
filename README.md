...
<!--
MAINTAINER-CONTEXT-BEGIN
This section is written and maintained exclusively by the repository owner.
Automated coding agents must not edit, reformat, move, summarize, or delete
this section or its boundary markers.
-->

## Maintainer note

Except for this section and the `LICENSE` file in the initial commit,
everything in this repo has been generated by OpenAI's Codex or via updates
such as `cargo update`. The project exists both to create a useful command
line transposition tool and a hopefully useful ABC parser library, but just
as importantly, this project is an experiment in vibe coding. As I review
the code, I'll work to explain to Codex (or later maybe Claude Code, etc)
what I want changed. If you review the history to this point, there have
been a few substantial rewrites where my original prompting resulted in
working code that I didn't like.
